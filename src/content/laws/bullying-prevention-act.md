...
- 公式解説: 文部科学省『いじめの防止等のための基本的な方針(平成29年最終改定)』(取得日: 2026-08-29)
- 公式解説: 文部科学省『いじめの重大事態の調査に関するガイドライン(令和6年8月改訂版)』(取得日: 2026-08-29) <!-- body-only: いじめの重大事態の調査に関するガイドライン(令和6年8月改訂版) -->
