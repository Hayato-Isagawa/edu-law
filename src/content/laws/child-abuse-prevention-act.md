...
EduLaw JP は **公式解説への入口** を整理するサイトです。サイト側で独自の法解釈・現場助言は加えません。詳しくは [ADR 0002 引用ルールと運用ポリシー](../../docs/decisions/0002-citation-rules-and-policy.md) を参照してください。

## 法令本文

- [児童虐待の防止等に関する法律 全文(e-Gov 法令検索)](https://laws.e-gov.go.jp/law/412AC1000000082/)

> 章構成・条文ごとの整理は別 PR で順次追加します。
